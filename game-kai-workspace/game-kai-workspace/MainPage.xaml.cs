...
namespace game_kai_workspace
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void OnOpenInventoryButtonClicked(object sender, EventArgs e)
        {
        ...
        private void OptionSelected(object sender, EventArgs e)
        {
            ...
            //This needs refactoring. These options should be loaded from the database and associated with items.
            options = new[]
            {
