...
namespace game_kai_workspace.ViewModels
{
    public class ItemsViewModel
    {
        public ObservableCollection<Item> Items { get; } = new ObservableCollection<Item>
        {
            ...
            new Item { Id = "5", Name = "Photograph", ImageSource = "portrait.png", Description="Looks like a younger version of Kai...possibly her younger sister.", Status = Item.ItemStatus.Unobtained },
            new Item { Id = "6", Name = "SD-Card", ImageSource = "sd-card.png", Description="A secret memory card hidden in a vintage camera.", Status = Item.ItemStatus.Unobtained },
        };
    }
}
