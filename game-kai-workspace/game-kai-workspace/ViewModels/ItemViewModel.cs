...
namespace game_kai_workspace.ViewModels
{
    public class ItemViewModel
    {
        ...
        public ItemViewModel()
        {
            ...
            {
                new Item { Id = "1", Name = "Briefcase", Description = "Your trusty old case. Battered and worn.", Status = Item.ItemStatus.Unobtained },
                new Item { Id = "2", Name = "9mm Handgun", Description = "Standard issue for an investigator doing dangerous work.", Status = Item.ItemStatus.Unobtained },
                new Item { Id = "3", Name = "Notepad", Description = "Your notes are comprehensive.", Status = Item.ItemStatus.Unobtained },
